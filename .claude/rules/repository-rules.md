...
paths:
  ...
  - "**/repository/**/*.dart"
---
# Repository / Data-Coordination Rules
...
Rules for the layer that coordinates services and maps raw data into domain models. Many projects
have this; some fold it into services. Rename/delete to match yours.

## FILL IN — describe the rules for this layer

> - What a repository combines and exposes (domain operations vs raw data).
> - The mapping rule: data-layer models (DTOs) don't leak upward.
> - Caching policy, if any, and where it's documented.
> - How it receives dependencies.
