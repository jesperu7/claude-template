...
Rules for widgets themselves: keeping logic out of the view, theming/tokens, localization,
accessibility, and asset access.

## FILL IN — describe the rules for this layer

> - The rule that widgets hold no logic — they read from the state-holder layer.
> - How design values are accessed (theme/tokens), never hardcoded.
> - How user-facing text is localized.
> - Dark/light support, accessibility expectations, and how assets are referenced (generated API, not string paths).
